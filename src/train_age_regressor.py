"""
File: train_age_regressor.py
Author: Rudy
Description: Train age regressor model from classifier model
"""
...
from models.cnn import regressor_VGG16
...
model = regressor_VGG16(input_shape, num_classes,
                        pre_trained_model_path='/donnees/rnoyelle/deep_annotation/models/dev_models/age_models/age_classifier_VGG16.04-0.04.hdf5')
