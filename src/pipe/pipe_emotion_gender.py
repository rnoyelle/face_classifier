...
for file in input_list:
    print("predicting age/gender/emotion for "+file+" ...")
    ...
    for face_coordinates in faces:
        ...
        draw_text(face_coordinates, rgb_image, gender_text, color, 0, 90, 1, 2)
        draw_text(face_coordinates, rgb_image, emotion_text, color, 0, 120, 1, 2)

    bgr_image = cv2.cvtColor(rgb_image, cv2.COLOR_RGB2BGR)
    i+=1
    cv2.imwrite('output/predicted/{}'.format(file), bgr_image)
    print("done !")
